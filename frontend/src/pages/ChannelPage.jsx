  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        <button
          className="bg-yellow-500 px-4 py-2 rounded-l-full text-white hover:bg-yellow-600 transition"
        ...
        <button
          className="bg-green-600 px-4 py-2 rounded-r-full text-white hover:bg-green-700 transition"
