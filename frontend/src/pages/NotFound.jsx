...
export default function NotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-6 text-center animate-fadeIn">
      ...
      <Link
        to="/"
        className="inline-block bg-yellow-600 text-white font-semibold px-7 py-3 rounded-full shadow-lg transition-transform transform hover:scale-105 hover:bg-yellow-700 focus:outline-none focus:ring-4 focus:ring-yellow-300"
      >
        Go to Home
      </Link>
    </div>
